...
const name = argv._[0];
const package =
    "https://github.com/piecioshka/nazwa-projektu/archive/master.zip";
...
(async () => {
    ...
    try {
        ...
        // Fetch github.com/piecioshka/nazwa-projektu
        await task(`wget ${package} -O nazwa-projektu.zip`);
        await task(`unzip nazwa-projektu.zip`);
        await task(`mv nazwa-projektu-master ${name}`);
        await task(`rm -rf nazwa-projektu.zip`);
        // Replace all "nazwa-projektu" by "NAME"
